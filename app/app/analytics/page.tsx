...
function UsdcValue({ amount }: { amount: number }) {
  return (
    <span className="flex items-baseline gap-2">
      ...
      <span className="font-mono text-sm text-ink/45">USDC</span>
    </span>
  );
}
...
function StatCard({
  ...
  return (
    <div className="glass-card px-5 py-6">
      ...
      {hint ? (
        <p className="mt-1 font-mono text-[11px] text-ink/40">{hint}</p>
      ) : null}
    </div>
  );
}
      ...
      <div className="relative z-10">
        ...
        <div className="px-4 py-10 sm:px-6 sm:py-12 lg:px-8">
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-2">
            <div className="glass-card glass-sheen px-6 py-8">
              <p className="font-mono text-[10px] uppercase tracking-[0.14em] text-ink/45">
                USDC on offer
              </p>
              <div className="mt-4">
